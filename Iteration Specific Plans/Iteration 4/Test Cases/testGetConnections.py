...
class testGetConnections(unittest.TestCase):
    ...
    def testGetAllPatientSecurity(self):
        """Attempt to get all connections for patient"""
        payload = {
            "username" : "patient",
        }
        result = requests.post("http://127.0.0.1:9999/api/getConnections", data=payload, auth=('Security', '73630002494546d52bdc16cf5874a41e720896b566cd8cb72afcf4f866d70570aa078832f3e953daaa2dca60aac7521a7b4633d12652519a2e2baee39e2b539c85ac5bdb82a9f237'))
        result = json.loads(result.text)
