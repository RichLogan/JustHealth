...
.. java:type:: public class EditSelfAppointment extends Activity
...
.. java:method:: protected void onCreate(Bundle savedInstanceState)
   :outertype: EditSelfAppointment

   This runs when the page is first loaded. The xml layout is assigned and the action bar is set Action listener added to the update button. Runs populate spinner to get the appointment types.
