...
class testGetAppointmentsDueIn30(unittest.TestCase):
	...
	def testLegitimate(self):
		"""Attempt to create a legitimate reminder || check that API returns expected response and DB is correct too"""
	...
	def testNotDueIn30(self):
		"""Attempt to check whether an appointment is due in 30 || check that the API returns expected response and nothing has been added to the DB"""
