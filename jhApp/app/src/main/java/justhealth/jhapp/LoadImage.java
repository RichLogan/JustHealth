...
public class LoadImage extends AsyncTask<String, Void, Bitmap> {
     ...
     */
    public LoadImage(ImageView iv, boolean blur, Context context) {
        this.iv = iv;
    ...
    protected Bitmap doInBackground(String... url) {
        ...
        //TODO: If stored in local storage then return that otherwise download.
    ...
    public static String getProfilePictureURL(String filename) {
        return Request.getServerURL() + "/api/images/" + filename;
    }
